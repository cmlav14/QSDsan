...
def _create_CANDO_cmps(pickle=False):
    ...
    cmps_CANDO = Components([S_NO3, S_NO2, S_NO, S_N2O, S_N2, S_S, S_PO4,
...
class CANDO(Processes):
    ...
    def __new__(cls, components=None, Y_PO4=0.3, Y_PHA=0.2, Y_DPAO_NOx=0.5, i_P_BM=0.02,
                i_P_XI=0.01,f_I=.2,q_PHA=.53,K_S_DPAO=10,K_PP_DPAO=.05,q_PP=.0375,
        ...
        self.set_parameters(Y_PO4=Y_PO4,Y_PHA=Y_PHA,Y_DPAO_NOx=Y_DPAO_NOx,
                            i_P_BM=i_P_BM,i_P_XI=i_P_XI,f_I=f_I,q_PHA=q_PHA,
